<RoutePrefix("api")>
Public Class GLS0060_Controller
   Inherits ApiController

   Private ReadOnly _databaseId As String = "sys"

   <SymAuthorization("GetReferences_GLS0060")>
   <Route("references/gls0060")>
   <HttpGet>
   Public Function GetReferences_GLS0060() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.GLS0060_References")
            With _direct
   ...
   Public Function GetFinTrx(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0060")
            With _direct
   ...
   Public Function GetFinTrxLog(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0060_Log")
            With _direct
               .AddParameter("TrxId", trxId)
   ...
   <Route("trans-adad/{currentUserId}")>
   <HttpPost>
   Public Function CreateFinTrx(currentUserId As Integer, <FromBody> trx As FinTrxBody) As IHttpActionResult
      ...
      Try
         ...
         If trx.DocumentId = "< NEW >" Then
            'trx.DocumentId = AppLib.GetNextDocSequence(DocSequencerId.JEV_ADADJ, trx.TrxDate)
   ...
   <Route("trans-adad/{trxId}/{currentUserId}")>
   <HttpPut>
