<RoutePrefix("api")>
Public Class GLS0040_Controller
   Inherits ApiController

   Private ReadOnly _databaseId As String = "sys"

   <SymAuthorization("GetReferences_GLS0040")>
   <Route("references/gls0040")>
   <HttpGet>
   Public Function GetReferences_GLS0040() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.GLS0040_References")
            With _direct
   ...
   Public Function GetFinTrx(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0040")
            With _direct
   ...
   Public Function GetFinTrxLog(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0040_Log")
            With _direct
               .AddParameter("TrxId", trxId)
   ...
   Public Function CreateFinTrx(currentUserId As Integer, <FromBody> trx As FinTrxBody) As IHttpActionResult
      ...
      Try
         ...
         If trx.DocumentId = "< NEW >" Then
            trx.DocumentId = AppLib.GetNextDocSequence(DocSequencerId.JEV_CDJ, trx.TrxDate)
         End If
         ...
         With _finTrx
            ...
            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ReferenceCDJ, String.Empty, .Reference)
   ...
   <Route("trans-cd/{trxId}/{currentUserId}")>
   <HttpPut>
      ...
      Try
         ...
         With _finTrxOld
            ...
            If .Reference <> _finTrx.Reference Then
               AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ReferenceCDJ, .Reference, _finTrx.Reference)
            End If
