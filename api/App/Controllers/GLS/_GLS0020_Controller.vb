<RoutePrefix("api")>
Public Class GLS0020_Controller
   Inherits ApiController

   Private ReadOnly _databaseId As String = "sys"

   <SymAuthorization("GetReferences_GLS0020")>
   <Route("references/gls0020")>
   <HttpGet>
   Public Function GetReferences_GLS0020() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.GLS0020_References")
            With _direct
   ...
   Public Function GetFinTrx(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0020")
            With _direct
   ...
   Public Function GetFinTrxLog(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0020_Log")
            With _direct
               .AddParameter("TrxId", trxId)
