<RoutePrefix("api")>
Public Class GLS0030_Controller
   Inherits ApiController

   Private ReadOnly _databaseId As String = "sys"

   <SymAuthorization("GetReferences_GLS0030")>
   <Route("references/gls0030")>
   <HttpGet>
   Public Function GetReferences_GLS0030() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.GLS0030_References")
            With _direct
   ...
   Public Function GetFinTrx(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0030")
            With _direct
   ...
   Public Function GetFinTrxLog(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0030_Log")
            With _direct
               .AddParameter("TrxId", trxId)
   ...
   Public Function CreateFinTrx(currentUserId As Integer, <FromBody> trx As FinTrxBody) As IHttpActionResult
      ...
      Try
         ...
         If trx.DocumentId = "< NEW >" Then
            trx.DocumentId = AppLib.GetNextDocSequence(DocSequencerId.JEV_CRJ, trx.TrxDate)
         End If
         ...
         With _finTrx
            ...
            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ReferenceCRJ, String.Empty, .Reference)

            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.CollectorName, String.Empty, .CollectorName)
   ...
   <Route("trans-cr/{trxId}/{currentUserId}")>
   <HttpPut>
      ...
      Try
         ...
         With _finTrxOld
            ...
            If .Reference <> _finTrx.Reference Then
               AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ReferenceCRJ, .Reference, _finTrx.Reference)
            End If

            If .CollectorName <> _finTrx.CollectorName Then
               AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.CollectorName, .CollectorName, _finTrx.CollectorName)
            End If
   ...
   Private Function HasFinTrxChanges(oldRecord As FinTrx, newRecord As FinTrx) As Boolean
      ...
      With oldRecord
         ...
         If .CollectorName <> newRecord.CollectorName Then Return True
