<RoutePrefix("api")>
Public Class GLS0050_Controller
   Inherits ApiController

   Private ReadOnly _databaseId As String = "sys"

   <SymAuthorization("GetReferences_GLS0050")>
   <Route("references/gls0050")>
   <HttpGet>
   Public Function GetReferences_GLS0050() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.GLS0050_References")
            With _direct
   ...
   Public Function GetFinTrxLog(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0050_Log")
            With _direct
               .AddParameter("TrxId", trxId)
   ...
   Public Function CreateFinTrx(currentUserId As Integer, <FromBody> trx As FinTrxBody) As IHttpActionResult
      ...
      Try
         ...
         If trx.DocumentId = "< NEW >" Then
            'trx.DocumentId = AppLib.GetNextDocSequence(DocSequencerId.JEV_CKDJ, trx.TrxDate)
         ...
         With _finTrx
            ...
            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ReferenceCKDJ, String.Empty, .Reference)

            'AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.DisburserName, String.Empty, .DisburserName)

            'AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.CheckSeriesFrom, String.Empty, .CheckSeriesFrom)
            'AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.CheckSeriesTo, String.Empty, .CheckSeriesTo)

            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.PayeeId, String.Empty, .PayeeId.ToString)
            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.CheckNumber, String.Empty, .CheckNumber)
   ...
   <Route("trans-ckd/{trxId}/{currentUserId}")>
   <HttpPut>
      ...
      Try
         ...
         With _finTrxOld
            ...
            If .Reference <> _finTrx.Reference Then
               AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ReferenceCKDJ, .Reference, _finTrx.Reference)
            End If
            ...
            'If .CheckSeriesFrom <> _finTrx.CheckSeriesFrom Then
            '   AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.CheckSeriesFrom, .CheckSeriesFrom, _finTrx.CheckSeriesFrom)
            'End If

            'If .CheckSeriesTo <> _finTrx.CheckSeriesTo Then
            '   AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.CheckSeriesTo, .CheckSeriesTo, _finTrx.CheckSeriesTo)
            'End If
            ...
            If .CheckNumber <> _finTrx.CheckNumber Then
               AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.CheckNumber, .CheckNumber, _finTrx.CheckNumber)
            End If
   ...
   Private Function HasFinTrxChanges(oldRecord As FinTrx, newRecord As FinTrx) As Boolean
      ...
      With oldRecord
         ...
         'If .CheckSeriesFrom <> newRecord.CheckSeriesFrom Then Return True
         'If .CheckSeriesTo <> newRecord.CheckSeriesTo Then Return True
