<RoutePrefix("api")>
Public Class GLS0070_Controller
   Inherits ApiController

   Private ReadOnly _databaseId As String = "sys"

   <SymAuthorization("GetReferences_GLS0070")>
   <Route("references/gls0070")>
   <HttpGet>
   Public Function GetReferences_GLS0070() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.GLS0070_References")
            With _direct
   ...
   Public Function GetFinTrx(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0070")
            With _direct
   ...
   Public Function GetFinTrxLog(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.GLS0070_Log")
            With _direct
               .AddParameter("TrxId", trxId)
   ...
   <Route("trans-emdsd/{currentUserId}")>
   <HttpPost>
   Public Function CreateFinTrx(currentUserId As Integer, <FromBody> trx As FinTrxBody) As IHttpActionResult
      ...
      Try
         ...
         If trx.DocumentId = "< NEW >" Then
            'trx.DocumentId = AppLib.GetNextDocSequence(DocSequencerId.JEV_EMDSDJ, trx.TrxDate)
            trx.DocumentId = AppLib.GetNextDocSequence(DocSequencerId.JEV_CAEDJ, trx.TrxDate)
         End If
         ...
         With _finTrx
            ...
            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.FundClusterId, String.Empty, .FundClusterId, .FundClusterId + "=" + _fundClusterName)
            ...
            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ReferenceADADJ, String.Empty, .Reference)

            'AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.DisburserName, String.Empty, .DisburserName)

            'AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ADASeriesFrom, String.Empty, .AdaSeriesFrom)
            'AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ADASeriesTo, String.Empty, .AdaSeriesTo)

            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.PayeeId, String.Empty, .PayeeId.ToString)
            'AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ADASeries, String.Empty, .AdaSeries)
            AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.EMDSSeries, String.Empty, .AdaSeries)
   ...
   <Route("trans-emdsd/{trxId}/{currentUserId}")>
   <HttpPut>
      ...
      Try
         ...
         With _finTrxOld
            ...
            If .Reference <> _finTrx.Reference Then
               AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ReferenceADADJ, .Reference, _finTrx.Reference)
            End If

            'If .DisburserName <> _finTrx.DisburserName Then
            '   AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.DisburserName, .DisburserName, _finTrx.DisburserName)
            'End If

            'If .AdaSeriesFrom <> _finTrx.AdaSeriesFrom Then
            '   AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ADASeriesFrom, .AdaSeriesFrom, _finTrx.AdaSeriesFrom)
            'End If

            'If .AdaSeriesTo <> _finTrx.AdaSeriesTo Then
            '   AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ADASeriesTo, .AdaSeriesTo, _finTrx.AdaSeriesTo)
            'End If

            If .PayeeId <> _finTrx.PayeeId Then
               AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.PayeeId, .PayeeId.ToString, _finTrx.PayeeId.ToString)
            End If

            If .AdaSeries <> _finTrx.AdaSeries Then
               'AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.ADASeries, .AdaSeries, _finTrx.AdaSeries)
               AppLib.AddLogDetail(_finTrxLogDetailList, 0, LogColumnId.EMDSSeries, .AdaSeries, _finTrx.AdaSeries)
            End If
   ...
   <Route("trans-emdsd/{trxId}/{lockId}")>
   <HttpDelete>
   ...
   Private Sub LoadFinTrx(row As DataRow, trx As FinTrx)
      ...
      With trx
         ...
         .JournalId = row.ToInt32("JournalId")
         ...
         .CollectorName = row.ToString("CollectorName")
         ...
         .CheckSeriesFrom = row.ToString("CheckSeriesFrom")
         .CheckSeriesTo = row.ToString("CheckSeriesTo")
         .CheckNumber = row.ToString("CheckNumber")
         .AdaSeriesFrom = row.ToString("AdaSeriesFrom")
         .AdaSeriesTo = row.ToString("AdaSeriesTo")
         .AdaSeries = row.ToString("AdaSeries")
   ...
   Private Sub AddInsertUpdateParamsFinTrx(trx As FinTrx)
      ...
      With DataCore.Command.Parameters
         ...
         .AddWithValue("@JournalId", trx.JournalId)
         .AddWithValue("@FundClusterId", trx.FundClusterId)
         .AddWithValue("@TrxStatusId", trx.TrxStatusId)
         .AddWithValue("@DocumentId", trx.DocumentId)
         .AddWithValue("@CostCenterId", trx.CostCenterId)
         ...
         .AddWithValue("@CollectorName", trx.CollectorName.ToNullable)
         .AddWithValue("@DisburserName", trx.DisburserName.ToNullable)
         .AddWithValue("@PayeeId", trx.PayeeId.ToNullable)
         '.AddWithValue("@PayorName", trx.PayorName.ToNullable)
         '.AddWithValue("@PayeeName", trx.PayeeName.ToNullable)
         .AddWithValue("@CheckSeriesFrom", trx.CheckSeriesFrom.ToNullable)
         .AddWithValue("@CheckSeriesTo", trx.CheckSeriesTo.ToNullable)
         .AddWithValue("@CheckNumber", trx.CheckNumber.ToNullable)
         .AddWithValue("@AdaSeriesFrom", trx.AdaSeriesFrom.ToNullable)
         .AddWithValue("@AdaSeriesTo", trx.AdaSeriesTo.ToNullable)
         .AddWithValue("@AdaSeries", trx.AdaSeries.ToNullable)
         .AddWithValue("RequestSignatoryId", trx.RequestSignatoryId)
         .AddWithValue("SignatoryId", trx.SignatoryId)
      End With
   ...
   Private Function HasFinTrxChanges(oldRecord As FinTrx, newRecord As FinTrx) As Boolean
      ...
      With oldRecord
         ...
         'If .DisburserName <> newRecord.DisburserName Then Return True
         'If .AdaSeriesFrom <> newRecord.AdaSeriesFrom Then Return True
         'If .AdaSeriesTo <> newRecord.AdaSeriesTo Then Return True
         If .PayeeId <> newRecord.PayeeId Then Return True
         If .AdaSeries <> newRecord.AdaSeries Then Return True
