...
Public Class PAY0020_Controller
   ...
   <SymAuthorization("GetTimekeepingClientPayGroup")>
   <Route("timekeeping-schedules-client-pay-group-id/{clientPayGroupId}")>
   <HttpGet>
   Public Function GetTimekeepingClientPayGroup(clientPayGroupId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.PAY0020_Schedule")
            With _direct
               ...
               Using _dataSet As DataSet = _direct.ExecuteDataSet()
                  With _dataSet
                     ...
                     .Tables(6).TableName = "cutOff"
                     .Tables(7).TableName = "restDay"
                  End With
   ...
   <HttpGet>
   Public Function GetReferences_PAY0020() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.PAY0020_References")
            With _direct
   ...
   <Route("timekeeping-schedules/{timekeepingSheetId}")>
   <HttpGet>
   Public Function GetTimekeepingSchedule(timekeepingSheetId As Integer) As IHttpActionResult
            ...
            With _direct
               ...
               Using _dataSet As DataSet = _direct.ExecuteDataSet()
                  With _dataSet
                     ...
                     .Tables(9).TableName = "cutOff"
                     .Tables(10).TableName = "restDay"
   ...
   <HttpPost>
   Public Function CreateTimekeepingSchedule(currentUserId As Integer, <FromBody> timekeeping As TimekeepingSheetBodyShedule) As IHttpActionResult
      ...
      Try
         ...
         Dim _payTimekeepingSheetMemberList As New PayTimekeepingSheetMemberScheduleList

         Me.LoadPayTimekeeping(timekeeping, _payTimekeeping)


         For Each _schedule As PayTimekeepingSheetMemberSchedule In timekeeping.Schedules
   ...
   <Route("timekeeping-schedules/{timekeepingSheetId}/{currentUserId}")>
   <HttpPut>
   Public Function ModifyTimekeepingSchedule(timekeepingSheetId As Integer, currentUserId As Integer, <FromBody> timekeeping As TimekeepingSheetBodyShedule) As IHttpActionResult
      ...
      Try
         ...
         Dim _payTimekeepingSheetMemberListOld As New PayTimekeepingSheetMemberScheduleList


         Dim _result As Results.OkNegotiatedContentResult(Of DataSet) = CType(Me.GetTimekeepingSchedule(timekeepingSheetId), Results.OkNegotiatedContentResult(Of DataSet))
...
#Region "PayTimekeepingSheetMember"
         ...
         For Each _old As PayTimekeepingSheetMemberSchedule In _payTimekeepingSheetMemberListOld
            _old.LogActionId = LogActionId.Delete
            For Each _new As PayTimekeepingSheetMemberSchedule In _payTimekeepingSheetMemberList
         ...
         Dim _payTimekeepingSheetMemberListNew As New PayTimekeepingSheetMemberScheduleList      ' for adding new Barangays

         If _addSheetMemberCount > 0 Then
            Dim _payTimekeepingSheetMember As PayTimekeepingSheetMemberSchedule

            For Each _new As PayTimekeepingSheetMemberSchedule In _payTimekeepingSheetMemberList
               If _new.LogActionId = LogActionId.Add Then
                  _payTimekeepingSheetMember = New PayTimekeepingSheetMemberSchedule
...
#End Region
   ...
   End Function
   Private Sub LoadPayTimekeeping(timekeeping As TimekeepingSheetBodyShedule, payTimekeeping As PayTimekeepingSheet)
   ...
   End Sub
   Private Sub LoadPayTimekeepingSheetMemberList(rows As DataRowCollection, list As PayTimekeepingSheetMemberScheduleList)

      Dim _detail As PayTimekeepingSheetMemberSchedule
      For Each _row As DataRow In rows
         _detail = New PayTimekeepingSheetMemberSchedule
   ...
   End Sub
   Private Sub InsertPayTimekeepingSheetMembers(list As PayTimekeepingSheetMemberScheduleList)
      ...
      With DataCore.Command
         ...
         For Each _detail As PayTimekeepingSheetMemberSchedule In list
   ...
   Private Sub AddInsertUpdateParamsPayTimekeepingSheetMember(dtl As PayTimekeepingSheetMemberSchedule)
   ...
   End Sub
   Private Sub UpdatePayTimekeepingSheetMembers(list As PayTimekeepingSheetMemberScheduleList)
   ...
   End Sub
   Private Sub DeletePayTimekeepingSheetMembers(list As PayTimekeepingSheetMemberScheduleList)

      With DataCore.Command
         .CommandText = "DELETE dbo.PayTimekeepingSheetMember WHERE SheetMemberId=@SheetMemberId"
         .CommandType = CommandType.Text

         For Each _old As PayTimekeepingSheetMemberSchedule In list
            If _old.LogActionId = LogActionId.Delete Then
               With .Parameters
                  .Clear()
...
End Class
Public Class TimekeepingSheetBodyShedule
   Inherits PayTimekeepingSheet

   Public Property Schedules As PayTimekeepingSheetMemberSchedule()
