<RoutePrefix("api")>
Public Class FIN0040_Controller
   Inherits ApiController

   Private ReadOnly _databaseId As String = "sys"

   <SymAuthorization("GetReferences_FIN0040")>
   <Route("references/fin0040")>
   <HttpGet>
   Public Function GetReferences_FIN0010() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.FIN0040_References")
            With _direct

               Using _dataSet As DataSet = _direct.ExecuteDataSet()
                  With _dataSet
                     .Tables(0).TableName = "trxTypes"
                  End With
   ...
   <SymAuthorization("GetJournalEntry")>
   <Route("journal-entry/{trxId}")>
   <HttpGet>
   Public Function GetJournalEntry(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.FIN0040")
            With _direct
   ...
   <SymAuthorization("GetJournalEntryLog")>
   <Route("journal-entry/{trxId}/log")>
   <HttpGet>
   Public Function GetJournalEntryLog(trxId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.FIN0040_Log")
            With _direct
               .AddParameter("TrxId", trxId)
   ...
   <SymAuthorization("CreateJournalEntry")>
   <Route("journal-entry/{currentUserId}")>
   <HttpPost>
   Public Function CreateJournalEntry(currentUserId As Integer, <FromBody> trx As FinTrxBody) As IHttpActionResult
      ...
      Try
         ...
         If trx.DocumentId = "< NEW >" Then
            Dim _trxTypeId As NextSeqId = CType(trx.TrxTypeId, NextSeqId)
            trx.DocumentId = AppLib.GetNextTrxTypeSequence(_trxTypeId)
         End If
   ...
   <SymAuthorization("ModifyJournalEntry")>
   <Route("journal-entry/{trxId}/{currentUserId}")>
   <HttpPut>
   Public Function ModifyJournalEntry(trxId As Integer, currentUserId As Integer, <FromBody> trx As FinTrxBody) As IHttpActionResult
      ...
      Try
         ...
         Dim _result As Results.OkNegotiatedContentResult(Of DataSet) = CType(Me.GetJournalEntry(trxId), Results.OkNegotiatedContentResult(Of DataSet))
         ...
         If Not _isFinTrxChanged AndAlso _addDetailCount = 0 AndAlso _removeDetailCount = 0 AndAlso _editDetailCount = 0 Then
            ...
            ' 
            Return Me.GetJournalEntry(trxId)
         End If
   ...
   <SymAuthorization("RemoveJournalEntry")>
   <Route("journal-entry/{trxId}/{lockId}")>
   <HttpDelete>
   Public Function RemoveJournalEntry(trxId As Integer, lockId As String) As IHttpActionResult
