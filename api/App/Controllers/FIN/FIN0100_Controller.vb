<RoutePrefix("api")>
Public Class FIN0100_Controller
   Inherits ApiController

   Private ReadOnly _databaseId As String = "sys"

   <SymAuthorization("GetReferences_FIN0100")>
   <Route("references/fin0100")>
   <HttpGet>
   Public Function GetReferences_FIN0100() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.FIN0100_References")
            With _direct
   ...
   Public Function GetFinAccount(accountId As String) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.FIN0100")
            With _direct
   ...
   Private Sub AddInsertUpdateParamsFinAccount(account As FinAccount)
      ...
      With DataCore.Command.Parameters
         ...
         .AddWithValue("@OrgId", account.OrgId.ToNullable)
      End With
