...
<RoutePrefix("api")>
Public Class APS0040_Controller
   Inherits ApiController

   Private ReadOnly _databaseId As String = "sys"

   <SymAuthorization("GetReferences_APS0040")>
   <Route("references/aps0040")>
   <HttpGet>
   Public Function GetReferences_APS0040() As IHttpActionResult

      Try
         Using _direct As New SqlDirect("web.APS0040_References")
            With _direct

               Using _dataSet As DataSet = _direct.ExecuteDataSet()
                  With _dataSet
                     .Tables(0).TableName = "payeeType"
   ...
   <SymAuthorization("GetPayee")>
   <Route("payees/{payeeId}")>
   <HttpGet>
   Public Function GetPayee(payeeId As Integer) As IHttpActionResult
      ...
      Try
         Using _direct As New SqlDirect("web.APS0040")
            With _direct
               .AddParameter("PayeeId", payeeId)

               Using _dataSet As DataSet = _direct.ExecuteDataSet()
                  With _dataSet
                     .Tables(0).TableName = "payee"
   ...
   Private Sub AddInsertUpdateParamsApsPayee(payee As ApsPayee)
      ...
      With DataCore.Command.Parameters
         ...
         .AddWithValue("@AccountId", payee.AccountId.ToNullable)
