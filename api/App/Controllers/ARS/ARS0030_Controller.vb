<RoutePrefix("api")>
Public Class ARS0030_Controller
    Inherits ApiController

    Private ReadOnly _databaseId As String = "sys"

    <SymAuthorization("GetArsMemberRequestHiredApplicantLog")>
    <Route("member-request-hired-applicants/{applicantDetailId}/log")>
    <HttpGet>
    Public Function GetArsMemberRequestHiredApplicantLog(applicantDetailId As Integer) As IHttpActionResult
        ...
        Try
            Using _direct As New SqlDirect("Web.ARS0030_Log")
                With _direct
   ...
   Public Function GetClientBillingTransactions(clientPayGroupId As Integer) As IHttpActionResult
      ...
      Dim _dataSource As String = "dbo.QArsClientBilling"
      Dim _fields As String = "ClientPayGroupId, PayTrxCode, PayTrxName, BillingSheetFormula, FixedAmount, PayGroupFlag, MemberRequestFlag, SystemCode"
      Dim _sort As String = "SortSeq"
   ...
   <SymAuthorization("GetClientPayOutTransactions")>
    ...
    Public Function GetClientPayOutTransactions(clientPayGroupId As Integer) As IHttpActionResult
        ...
        Dim _filter As String = "ClientPayGroupId=" + clientPayGroupId.ToString
        Dim _dataSource As String = "dbo.QArsClientPayOut"
        Dim _fields As String = "ClientPayGroupId, PayTrxCode, PayTrxName, PayOutSheetFormula, FixedAmount, PayGroupFlag, MemberRequestFlag, SystemCode"
        Dim _sort As String = "SortSeq"
    ...
    <SymAuthorization("GetRateDetail")>
    <Route("member-request-rate-details/{memberRequestId}/{clientPayGroupId}/{basic}/{deminimis}/{allowance}/{workingDays}/{deploymentDate}")>
    <HttpGet>
    Public Function GetRateDetail(memberRequestId As Integer, clientPayGroupId As Integer, basic As Decimal, deminimis As Decimal, allowance As Decimal, workingDays As Integer, deploymentDate As Date) As IHttpActionResult

        Try
            Using _direct As New SqlDirect("web.ARS0030_RateDetail")
                With _direct
                    .AddParameter("MemberRequestId", memberRequestId)
                    .AddParameter("ClientPayGroupId", clientPayGroupId)
                    .AddParameter("Basic", basic)
                    .AddParameter("Deminimis", deminimis)
                    .AddParameter("Allowance", allowance)

                    Dim rateList As New ArsMemberRequestRateDetailList()

                    Using _dataSet As DataSet = _direct.ExecuteDataSet()
                        With _dataSet
                            ' Iterate through the dataset's rows
                            For Each _row As DataRow In .Tables(0).Rows
                                Dim _rate As New ArsMemberRequestRateDetail

                                With _rate
                                    ' Populate the properties with the values from the data row
                                    .PayTrxCode = _row("PayTrxCode").ToString()
                              ...
                              .DailyRate = result
                              Select Case .PayTrxCode
                                 Case "SSS"
                                    .DailyRate = GetSssRate(result, deploymentDate) * 12 / workingDays
                                    .MonthlyRate = GetSssRate(result, deploymentDate)


                                 Case "PAGIB"
                                    .DailyRate = GetPbgRate(result, deploymentDate) * 12 / workingDays
                                       .MonthlyRate = GetPbgRate(result, deploymentDate)

                                 Case "EC"
                                    .DailyRate = GetEcRate(result, deploymentDate) * 12 / workingDays
                                       .MonthlyRate = GetEcRate(result, deploymentDate) * 12 / workingDays

                                 Case "PROV"
                                    .DailyRate = GetWispRate(result, deploymentDate) * 12 / workingDays
                                       .MonthlyRate = GetWispRate(result, deploymentDate) * 12 / workingDays

                                 Case "PHIL"
                                    .DailyRate = GetPhhRate(result, deploymentDate) * 12 / workingDays
                                       .MonthlyRate = GetPhhRate(result, deploymentDate) * 12 / workingDays
                                 Case Else
                              ...
                              '   .DailyRate = GetSssRate(result, deploymentDate) * 12 / workingDays
                              '   .MonthlyRate = GetSssRate(result, deploymentDate)
                              '   File.WriteAllText("e:\sss.txt", .MonthlyRate.ToString)
                              'End If
    ...
    <SymAuthorization("GetRegionMinimumWage")>
    <Route("member-request-minimum-wages/{memberRequestId}/{clientPayGroupId}/{workingDays}/{deploymentDate}/{minimumWageFlag}")>
    <HttpGet>
    Public Function GetRegionMinimumWage(memberRequestId As Integer, clientPayGroupId As Integer, workingDays As Integer, deploymentDate As Date, minimumWageFlag As Boolean) As IHttpActionResult

        Try
            Using _direct As New SqlDirect("web.ARS0030_Rate")
                With _direct
                    .AddParameter("MemberRequestId", memberRequestId)
                    .AddParameter("ClientPayGroupId", clientPayGroupId)
                    .AddParameter("WorkingDays", workingDays)
                    .AddParameter("DeploymentDate", deploymentDate)
                    .AddParameter("MinimumWageFlag", minimumWageFlag)
    ...
    <SymAuthorization("GetMembers")>
    <Route("request-members")>
    <HttpGet>
    Public Function GetRequestMembers() As IHttpActionResult

        Dim _filter As String = ""
        Dim _dataSource As String = "dbo.QHrsMember"
        Dim _fields As String = "MemberId, MemberName, BirthDate, Age, SexName, MobileNumber"
    ...
    <SymAuthorization("GetReferences_ARS0030")>
    <Route("references/ars0030")>
    <HttpGet>
    Public Function GetReferences_ARS0030() As IHttpActionResult

        Try
            Using _direct As New SqlDirect("web.ARS0030_References")
                With _direct
                    Using _dataSet As DataSet = _direct.ExecuteDataSet()
                        With _dataSet
                            ...
                            .Tables(20).TableName = "requestType"     ' all defined Transaction Types
                            .Tables(21).TableName = "docType"     ' all defined Transaction Types
    ...
    <SymAuthorization("GetMemberRequestForm")>
    <Route("member-requests/{memberRequestId}")>
    <HttpGet>
    Public Function GetMemberRequest(memberRequestId As Integer) As IHttpActionResult
        ...
        Try
            Using _direct As New SqlDirect("web.ARS0030")
                With _direct
                    .AddParameter("MemberRequestId", memberRequestId)
                    ...
                    Using _dataSet As DataSet = _direct.ExecuteDataSet()
                        With _dataSet
                            ...
                            .Tables(19).TableName = "docs"
                            .Tables(20).TableName = "basic"
    ...
    <SymAuthorization("GetRequestProvinces")>
    <Route("request-provinces/{regionId}")>
    <HttpGet>
    Public Function GetRequestProvinces(regionId As Integer) As IHttpActionResult
    ...
    <SymAuthorization("GetRequestMunicipalities")>
    <Route("request-municipalities/{regionId}/{provinceId}")>
    <HttpGet>
    Public Function GetRequestMunicipalities(regionId As Integer, provinceId As Integer) As IHttpActionResult
    ...
    <Route("member-requests/{currentUserId}")>
    <HttpPost>
    Public Function CreateMemberRequest(currentUserId As Integer, <FromBody> memberRequest As ArsMemberRequestBody) As IHttpActionResult
        ...
        Try
            ...
            Dim _arsMemberRequestDocTypeList As New ArsMemberRequestDocTypeList
            ...
            For Each _docType As ArsMemberRequestDocType In memberRequest.Docs
                _docType.MemberRequestId = _memberRequestId
                _arsMemberRequestDocTypeList.Add(_docType)
            Next
            ...
            Try
                ...
                If _arsMemberRequestDocTypeList.Count > 0 Then
                    Me.InsertArsMemberRequestDocTypes(_arsMemberRequestDocTypeList)
                End If
    ...
    <Route("member-requests/{memberRequestId}/{currentUserId}")>
    <HttpPut>
    Public Function ModifyArsMemberRequest(memberRequestId As Integer, currentUserId As Integer, <FromBody> memberRequest As ArsMemberRequestBody) As IHttpActionResult
        ...
        Try
            ...
            Dim _arsMemberRequestDocTypeListOld As New ArsMemberRequestDocTypeList

            Dim _result As Results.OkNegotiatedContentResult(Of DataSet) = CType(Me.GetMemberRequest(memberRequestId), Results.OkNegotiatedContentResult(Of DataSet))
            ...
            Using _dataSet As DataSet = _result.Content
                ...
                Me.LoadArsMemberRequestDocTypeList(_dataSet.Tables("docs").Rows, _arsMemberRequestDocTypeListOld)
            ...
            For Each _new As ArsMemberRequestBilling In _arsMemberRequestBillingList
                ...
                For Each _old As ArsMemberRequestBilling In _arsMemberRequestBillingListOld
                    If _new.BillingDetailId = _old.BillingDetailId Then
                     ...
                     If .BillingDetailId <> _old.BillingDetailId OrElse .DailyRate <> _old.DailyRate OrElse .MonthlyRate <> _old.MonthlyRate OrElse .PayTrxCode <> _old.PayTrxCode OrElse .FixedFlag <> _old.FixedFlag Then
                        .LogActionId = LogActionId.Edit
                     End If
                  End With
            ...
            For Each _new As ArsMemberRequestPayOut In _arsMemberRequestPayOutList
                ...
                For Each _old As ArsMemberRequestPayOut In _arsMemberRequestPayOutListOld
                    If _new.PayOutDetailId = _old.PayOutDetailId Then
                     ...
                     If .PayOutDetailId <> _old.PayOutDetailId OrElse .DailyRate <> _old.DailyRate OrElse .MonthlyRate <> _old.MonthlyRate OrElse .PayTrxCode <> _old.PayTrxCode OrElse .FixedFlag <> _old.FixedFlag Then
                        .LogActionId = LogActionId.Edit
                     End If
                  End With
...
#Region "ArsMemberRequestDocType"
            ...
            For Each _old As ArsMemberRequestDocType In _arsMemberRequestDocTypeListOld
                _old.LogActionId = LogActionId.Delete
                For Each _new As ArsMemberRequestDocType In _arsMemberRequestDocTypeList
                    If _new.MemberRequestDocTypeDetailId = _old.MemberRequestDocTypeDetailId Then
                        _old.LogActionId = 0  ' retain
                    End If
                Next
            ...
            Dim _arsMemberRequestDocTypeListNew As New ArsMemberRequestDocTypeList      ' for adding new Template Details

            If _addDocTypeCount > 0 Then
                Dim _arsMemberRequestDocType As ArsMemberRequestDocType

                For Each _new As ArsMemberRequestDocType In _arsMemberRequestDocTypeList
                    If _new.LogActionId = LogActionId.Add Then
                        _arsMemberRequestDocType = New ArsMemberRequestDocType
                        _arsMemberRequestDocTypeListNew.Add(_arsMemberRequestDocType)
                        DataLib.ScatterValues(_new, _arsMemberRequestDocType)
                        _arsMemberRequestDocType.MemberRequestId = _arsMemberRequest.MemberRequestId
                    End If
                Next
...
#End Region
            ...
            Try
                ...
                If _removeDocTypeCount > 0 Then
                    Me.DeleteArsMemberRequestDocTypes(_arsMemberRequestDocTypeListOld)
                End If

                If _addDocTypeCount > 0 Then
                    Me.InsertArsMemberRequestDocTypes(_arsMemberRequestDocTypeListNew)
                End If

                If _editDocTypeCount > 0 Then
                    Me.UpdateArsMemberRequestDocTypes(_arsMemberRequestDocTypeList)
                End If
    ...
    <Route("member-requests/{memberRequestId}/{lockId}")>
    <HttpDelete>
    ...
    Private Sub LoadArsMemberRequest(row As DataRow, memberRequest As ArsMemberRequest)
        ...
        With memberRequest
         ...
         .EmploymentEndDate = row.ToDate("EmploymentEndDate")
         ...
         '.EndDate = row.ToDate("EndDate") --PBN03142025
         ...
         .MemberRequestRemarks = row.ToString("MemberRequestRemarks")
         .MemberRequestPerks = row.ToString("MemberRequestPerks")
    ...
    Private Sub LoadArsMemberRequestBillingList(rows As DataRowCollection, list As ArsMemberRequestBillingList)
        ...
        For Each _row As DataRow In rows
            ...
            .MonthlyRate = _row.ToDecimal("MonthlyRate")
            .FixedFlag = _row.ToBoolean("FixedFlag")
    ...
    End Sub
    Private Sub LoadArsMemberRequestDocTypeList(rows As DataRowCollection, list As ArsMemberRequestDocTypeList)

        Dim _detail As ArsMemberRequestDocType
        For Each _row As DataRow In rows
            _detail = New ArsMemberRequestDocType

            With _detail
                .MemberRequestDocTypeDetailId = _row.ToInt32("MemberRequestDocTypeDetailId")
                .MemberRequestId = _row.ToInt32("MemberRequestId")
    ...
    Private Sub InsertArsMemberRequestDocTypes(list As ArsMemberRequestDocTypeList)

        Dim _excludedFields As New List(Of String)

        With _excludedFields
            .Add("MemberRequestDocTypeDetailId")     ' auto-assigned by DB
            .Add("LogActionId")
            .Add("LockId")
        End With

        With DataCore.Command
            .CommandText = DataLib.BuildInsertCommandText("dbo.ArsMemberRequestDocType", list(0), _excludedFields)
            .CommandType = CommandType.Text

            For Each _detail As ArsMemberRequestDocType In list
                Me.AddInsertUpdateParamsArsMemberRequestDocType(_detail)
                .ExecuteNonQuery()
            Next
    ...
    End Sub
    Private Sub UpdateArsMemberRequestDocTypes(list As ArsMemberRequestDocTypeList)

        Dim _keyFields As New List(Of String)
        Dim _excludedFields As New List(Of String)

        With _keyFields
            .Add("MemberRequestDocTypeDetailId")
        End With
        ...
        With DataCore.Command
            .CommandText = DataLib.BuildUpdateCommandText("dbo.ArsMemberRequestDocType", list(0), _keyFields, _excludedFields)
            .CommandType = CommandType.Text

            For Each _detail As ArsMemberRequestDocType In list
                If _detail.LogActionId = LogActionId.Edit Then
                    Me.AddInsertUpdateParamsArsMemberRequestDocType(_detail)
                    .Parameters.AddWithValue("@MemberRequestDocTypeDetailId", _detail.MemberRequestDocTypeDetailId)
    ...
    Private Sub AddInsertUpdateParamsArsMemberRequest(memberRequest As ArsMemberRequest)
        ...
        With DataCore.Command.Parameters
         ...
         .AddWithValue("@EmploymentTypeId", memberRequest.EmploymentTypeId)
         .AddWithValue("@EmploymentEndDate", memberRequest.EmploymentEndDate.ToNullable)
         ...
         '.AddWithValue("@EndDate", memberRequest.EndDate) --PBN 03142025
         .AddWithValue("@RateAmount", memberRequest.RateAmount)
         .AddWithValue("@DeminimisAmount", memberRequest.DeminimisAmount)
         .AddWithValue("@AllowanceAmount", memberRequest.AllowanceAmount)

         .AddWithValue("@MinimumWageFlag", memberRequest.MinimumWageFlag)
         .AddWithValue("@RequestTypeId", memberRequest.RequestTypeId)
         .AddWithValue("@EducationLevelId", memberRequest.EducationLevelId)
         .AddWithValue("@MemberRequestRemarks", memberRequest.MemberRequestRemarks)
         .AddWithValue("@MemberRequestPerks", memberRequest.MemberRequestPerks)
         .AddWithValue("@Name2", memberRequest.Name2)
         .AddWithValue("@Name3", memberRequest.Name3)
         .AddWithValue("@Name4", memberRequest.Name4)
         .AddWithValue("@Name5", memberRequest.Name5)
         .AddWithValue("@Name6", memberRequest.Name6)
         .AddWithValue("@Name7", memberRequest.Name7)
         .AddWithValue("@MemberId", memberRequest.MemberId)
   ...
   End Sub
    ...
    Private Sub AddInsertUpdateParamsArsMemberRequestBilling(dtl As ArsMemberRequestBilling)
        ...
        With DataCore.Command.Parameters
         ...
         .AddWithValue("@MonthlyRate", dtl.MonthlyRate)
         .AddWithValue("@FixedFlag", dtl.FixedFlag)
      End With
    ...
    End Sub
    Private Sub AddInsertUpdateParamsArsMemberRequestDocType(dtl As ArsMemberRequestDocType)

        With DataCore.Command.Parameters
            .Clear()
            .AddWithValue("@MemberRequestId", dtl.MemberRequestId)
            .AddWithValue("@DocTypeId", dtl.DocTypeId)
        End With
    ...
    End Sub
    Private Sub DeleteArsMemberRequestDocTypes(list As ArsMemberRequestDocTypeList)

        With DataCore.Command
            .CommandText = "DELETE dbo.ArsMemberRequestDocType WHERE MemberRequestDocTypeDetailId=@MemberRequestDocTypeDetailId"
            .CommandType = CommandType.Text

            For Each _old As ArsMemberRequestDocType In list
                If _old.LogActionId = LogActionId.Delete Then
                    With .Parameters
                        .Clear()
                        .AddWithValue("@MemberRequestDocTypeDetailId", _old.MemberRequestDocTypeDetailId)
                    End With
    ...
    Private Function HasArsMemberRequestChanges(oldRecord As ArsMemberRequest, newRecord As ArsMemberRequest) As Boolean
        ...
        With oldRecord
         ...
         If .EmploymentTypeId <> newRecord.EmploymentTypeId Then Return True
         If .EmploymentEndDate <> newRecord.EmploymentEndDate Then Return True
         ...
         'If .EndDate <> newRecord.EndDate Then Return True --PBN03142025
      End With
...
Public Class ArsMemberRequestBody
    ...
    Public Property Docs As ArsMemberRequestDocType()
End Class
