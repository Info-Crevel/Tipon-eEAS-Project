Public Class PayTimekeepingPayOutMember

   Public Property PayOutMemberId As Integer
   Public Property TimekeepingPayOutId As Integer
   ...
   Public Property SSSEC As Decimal
   Public Property PFER As Decimal
   Public Property PFEE As Decimal
   Public Property PBGER As Decimal
   Public Property PBGEE As Decimal
   Public Property PHHER As Decimal
   Public Property PHHEE As Decimal

   Public Property GrossPay As Decimal
   Public Property GrossShare As Decimal
   Public Property TotalShare As Decimal

   Public Property MPL As Decimal
   Public Property SL4 As Decimal
   Public Property SL1 As Decimal
   Public Property SPL As Decimal
   Public Property EL As Decimal
   Public Property SL3 As Decimal
   Public Property SAL As Decimal
   Public Property EP As Decimal
   Public Property CSC As Decimal
   Public Property PML3 As Decimal
   Public Property CMF As Decimal
   Public Property PCL2 As Decimal
   Public Property CS As Decimal
   Public Property SSL As Decimal
   Public Property SSL2 As Decimal
   Public Property SCL As Decimal
   Public Property PML As Decimal
   Public Property PCL As Decimal
   Public Property PML2 As Decimal
   Public Property PAI As Decimal
   Public Property CAN As Decimal
   Public Property ACC As Decimal
   Public Property SD As Decimal
   Public Property TotalDeduction As Decimal
   Public Property NetShare As Decimal
...
Public Class PayTimekeepingPayOutMemberList
   Inherits List(Of PayTimekeepingPayOutMember)
