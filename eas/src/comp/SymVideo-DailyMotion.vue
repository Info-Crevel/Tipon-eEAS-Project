<template>
  <figure class="dailymotion-container">
    <div class="dailymotion-wrapper" :style="wrapperStyle" ref="wrapper">
      <iframe
        class="dailymotion"
        v-bind="videoAttrs"
        :src="videoPath"
...
const videoUrl = "https://www.dailymotion.com/embed/video/";
...
export default {
  ...
  computed: {
    videoPath () {
      let
        q = 'queue-enable=0&subtitles-default=en&sharing-enable=0',
...
.dailymotion-wrapper .dailymotion {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
