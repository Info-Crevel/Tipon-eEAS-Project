// ADA Disbursements Journal Entry

<template>
<section class="container p-0" :key="ts">
<sym-form id="gls0060" :caption="pageName" cardClass="curved-0" headerClass="frs-form-header" footerClass="border-top-main frs-form-footer darken-2 py-0" bodyClass="frs-form-body pb-3">
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0060A" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0060B" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
...
export default {
  ...
  computed: {
    ...
    docId () {
      return this.trx.documentId + ' (ADADJ)';
    },
  ...
  methods: {
      ...
      me.getReferences()
        ...
        .then( info => {
          ...
          if (info && info.trx.length) {
            ...
            me.trx.journalId = 5;               // ADA Disbursements Journal
    ...
    getTrx () {
      return get('api/trans-adad/' + this.trx.trxId);
    },
    ...
    getReferences () {
      ...
      return get('api/references/gls0060');
    },

    getChangeLog () {
      return get('api/trans-adad/' + this.trx.trxId + '/log');
    },
    ...
    createRecord () {
      ...
      return ajax('api/trans-adad/' + currentUserId, options);
    },
    ...
    modifyRecord () {
      ...
      return ajax('api/trans-adad/' + this.trx.trxId + '/' + currentUserId, options);
    },
    ...
    deleteRecord () {
      ...
      return ajax('api/trans-adad/' + trx.trxId + '/' + trx.lockId, options);
    },
    ...
    trxIdCallback (e) {
      ...
      let filter = 'TrxId=' + e.proposedValue + ' AND JournalId=5'
    ...
    onSelectTemplate () {
      ...
      let options = {
        triggerControl: me,
        filter: 'JournalId = 5',      // ADA disbursements
        sort: '',
        size: '',
        dismissible: true,
        searchValue: ''
