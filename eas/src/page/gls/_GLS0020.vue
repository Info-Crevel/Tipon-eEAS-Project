...
<sym-form id="gls0020" :caption="pageName" cardClass="curved-0" headerClass="frs-form-header" footerClass="border-top-main frs-form-footer darken-2 py-0" bodyClass="frs-form-body pb-3">
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0020A" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0020B" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
...
export default {
  ...
  methods: {
      ...
      me.getReferences()
        ...
        .then( info => {
          ...
          if (info && info.trx.length) {
            ...
            me.trx.journalId = 1;               // General Journal
    ...
    getReferences () {
      ...
      return get('api/references/gls0020');
    },
    ...
    trxIdCallback (e) {
      ...
      let filter = 'TrxId=' + e.proposedValue + ' AND JournalId=1';
    ...
    onSelectTemplate () {
      ...
      let options = {
        triggerControl: me,
        filter: 'JournalId = 1',      // general journal
        sort: '',
        size: '',
        dismissible: true,
        searchValue: ''
