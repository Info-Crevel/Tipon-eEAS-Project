// Check Disbursements Journal Entry

<template>
<section class="container p-0" :key="ts">
<sym-form id="gls0050" :caption="pageName" cardClass="curved-0" headerClass="frs-form-header" footerClass="border-top-main frs-form-footer darken-2 py-0" bodyClass="frs-form-body pb-3">
  ...
  <div>
    <!-- <div class="d-flex justify-between align-items-end fw-118 ">
      <sym-int v-model="trx.trxId" :caption-width="42" :input-width="34" caption="Transaction ID" lookupId="FinTrxCheckDisbursement" @lostfocus="onTrxIdLostFocus" @changing="onTrxIdChanging" @changed="onTrxIdChanged" @searchresult="onTrxIdSearchResult"></sym-int>
    ...
    <!-- <sym-text v-model="trx.reference" :caption-width="42" :input-width="44" caption="RCI / DV #"></sym-text> -->
    <sym-text v-model="trx.reference" :caption-width="42" :input-width="44" caption="DV Number"></sym-text>
    ...
    <!-- <sym-text v-model="trx.checkSeriesFrom" :caption-width="42" :input-width="54" caption="Check Ser. # (From)"></sym-text> -->
    <!-- <sym-text v-model="trx.checkSeriesTo" :caption-width="42" :input-width="54" caption="Check Ser. # (To)"></sym-text> -->

    <sym-text v-model="trx.checkNumber" :caption-width="42" :input-width="44" caption="Check Number"></sym-text>
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0050A" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0050B" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
...
export default {
  ...
  computed: {
    ...
    docId () {
      return this.trx.documentId + ' (CKDJ)';
    },
  ...
  methods: {
      ...
      me.getReferences()
        ...
        .then( info => {
          ...
          if (info && info.trx.length) {
            ...
            me.trx.journalId = 4;               // Check Disbursements Journal
    ...
    getTrx () {
      return get('api/trans-ckd/' + this.trx.trxId);
    },
    ...
    getReferences () {
      ...
      return get('api/references/gls0050');
    },

    getChangeLog () {
      return get('api/trans-ckd/' + this.trx.trxId + '/log');
    },
    ...
    createRecord () {
      ...
      return ajax('api/trans-ckd/' + currentUserId, options);
    },
    ...
    modifyRecord () {
      ...
      return ajax('api/trans-ckd/' + this.trx.trxId + '/' + currentUserId, options);
    },
    ...
    deleteRecord () {
      ...
      return ajax('api/trans-ckd/' + trx.trxId + '/' + trx.lockId, options);
    },
    ...
    trxIdCallback (e) {
      ...
      let filter = 'TrxId=' + e.proposedValue + ' AND JournalId=4'
    ...
    // onDisburserNameSearchResult (result) {
    //   if (!result) { return; }

    //   this.trx.disburserName = result[0].disburserName;
    //   this.focusNext();
    // },

    // onPayeeNameSearchResult (result) {
    //   if (!result) { return; }

    //   this.trx.payeeName = result[0].payeeName;
    //   this.focusNext();
    // },
    ...
    onSelectTemplate () {
      ...
      let options = {
        triggerControl: me,
        filter: 'JournalId = 4',      // check disbursements
        sort: '',
        size: '',
        dismissible: true,
        searchValue: ''
