...
<sym-form id="gls0030" :caption="pageName" cardClass="curved-0" headerClass="frs-form-header" footerClass="border-top-main frs-form-footer darken-2 py-0" bodyClass="frs-form-body pb-3">
  ...
  <div>
    ...
    <!-- <sym-memo v-model="trx.particulars" :input-width="160" caption="Particulars" :input-height="6"></sym-memo> -->

    <div class="grid cols-2 gap-1">
      <sym-memo v-model="trx.particulars" caption="Particulars" :input-height="6"></sym-memo>
      <sym-memo v-model="trx.remarks" caption="Remarks" :input-height="6"></sym-memo>
    </div>

    <sym-text v-model="trx.reference" :caption-width="42" :input-width="44" caption="RCD / CRReg #"></sym-text>
    <!-- <sym-text v-model="trx.collectorName" :caption-width="42" :input-width="108" caption="Collecting Officer" lookupId="DbsCollectorName" @searchresult="onCollectorNameSearchResult"></sym-text> -->
    <sym-text v-model="trx.collectorName" :caption-width="42" :input-width="100" caption="Collecting Officer" lookupId="DbsCollectorName" @searchresult="onCollectorNameSearchResult"></sym-text>

    <div class="d-flex gap-1">
      <!-- <sym-int v-model="trx.requestSignatoryId" :caption-width="42" :input-width="22" caption="Prepared By" lookupId="DbsSignatory" @changing="onRequestSignatoryIdChanging" @searchfill="onRequestSignatoryIdSearchFill" @searchresult="onRequestSignatoryIdSearchResult"></sym-int>
      <sym-text v-model="trx.requestSignatoryName" :input-width="84"></sym-text> -->
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0030A" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0030B" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
...
export default {
  ...
  computed: {
    ...
    docId () {
      return this.trx.documentId + ' (CRJ)';
    },
  ...
  methods: {
      ...
      me.getReferences()
        ...
        .then( info => {
          ...
          if (info && info.trx.length) {
            ...
            me.trx.journalId = 2;               // Cash Receipts Journal
    ...
    getTrx () {
      return get('api/trans-cr/' + this.trx.trxId);
    },
    ...
    getReferences () {
      ...
      return get('api/references/gls0030');
    },

    getChangeLog () {
      return get('api/trans-cr/' + this.trx.trxId + '/log');
    },
    ...
    createRecord () {
      ...
      return ajax('api/trans-cr/' + currentUserId, options);
    },
    ...
    modifyRecord () {
      ...
      return ajax('api/trans-cr/' + this.trx.trxId + '/' + currentUserId, options);
    },
    ...
    deleteRecord () {
      ...
      return ajax('api/trans-cr/' + trx.trxId + '/' + trx.lockId, options);
    },
    ...
    trxIdCallback (e) {
      ...
      let filter = 'TrxId=' + e.proposedValue + ' AND JournalId=2'
    ...
    onCollectorNameSearchResult (result) {
      if (!result) { return; }

      this.trx.collectorName = result[0].collectorName;
      this.focusNext();
    },
    ...
    onSelectTemplate () {
      ...
      let options = {
        triggerControl: me,
        filter: 'JournalId = 2',      // cash receipts
        sort: '',
        size: '',
        dismissible: true,
        searchValue: ''
