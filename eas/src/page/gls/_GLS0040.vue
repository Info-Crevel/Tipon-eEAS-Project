...
<sym-form id="gls0040" :caption="pageName" cardClass="curved-0" headerClass="frs-form-header" footerClass="border-top-main frs-form-footer darken-2 py-0" bodyClass="frs-form-body pb-3">
  ...
  <div>
    <!-- <div class="d-flex justify-between align-items-end fw-118 ">
      <sym-int v-model="trx.trxId" :caption-width="42" :input-width="34" caption="Transaction ID" lookupId="FinTrxCashDisbursement" @lostfocus="onTrxIdLostFocus" @changing="onTrxIdChanging" @changed="onTrxIdChanged" @searchresult="onTrxIdSearchResult"></sym-int>
    ...
    <!-- <sym-memo v-model="trx.particulars" :input-width="160" caption="Particulars"></sym-memo> -->
    ...
    <!-- <sym-text v-model="trx.reference" :caption-width="42" :input-width="44" caption="RCDisb #"></sym-text> -->
    <sym-text v-model="trx.reference" :caption-width="42" :input-width="44" caption="DV Number"></sym-text>
    <sym-text v-model="trx.disburserName" :caption-width="42" :input-width="100" caption="Disbursing Officer" lookupId="DbsDisburser" @searchresult="onDisburserNameSearchResult"></sym-text>
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0040A" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
  ...
  <div class="board p-1 mb-0 w-100">
    <form id="gls0040B" class="curved-bottom border-dark marianblue p-3" @submit.prevent>
...
export default {
  ...
  computed: {
    ...
    docId () {
      return this.trx.documentId + ' (CDJ)';
    },
  ...
  methods: {
      ...
      me.getReferences()
        ...
        .then( info => {
          ...
          if (info && info.trx.length) {
            ...
            me.trx.journalId = 3;               // Cash Disbursements Journal
    ...
    getTrx () {
      return get('api/trans-cd/' + this.trx.trxId);
    },
    ...
    getReferences () {
      ...
      return get('api/references/gls0040');
    },

    getChangeLog () {
      return get('api/trans-cd/' + this.trx.trxId + '/log');
    },
    ...
    createRecord () {
      ...
      return ajax('api/trans-cd/' + currentUserId, options);
    },
    ...
    modifyRecord () {
      ...
      return ajax('api/trans-cd/' + this.trx.trxId + '/' + currentUserId, options);
    },
    ...
    deleteRecord () {
      ...
      return ajax('api/trans-cd/' + trx.trxId + '/' + trx.lockId, options);
    },
    ...
    trxIdCallback (e) {
      ...
      let filter = 'TrxId=' + e.proposedValue + ' AND JournalId=3'
    ...
    onSelectTemplate () {
      ...
      let options = {
        triggerControl: me,
        filter: 'JournalId = 3',      // cash disbursements
        sort: '',
        size: '',
        dismissible: true,
        searchValue: ''
